...
export default function Home() {
  ...
  async function getAssetsByCreator(creatorAddress: PublicKey) {
    const sortBy = {
      sortBy: "created",
      sortDirection: "asc",
    };
    ...
    const before = "";
    const after = "";
    const allAssetsOwned = await CONNECTION.getAssetsByCreator(
    ...
    console.log(allAssetsOwned);
    console.log(allAssetsOwned.data);
  }
    ...
    <main className="min-h-screen bg-blue-500 p-2">
      {
        <div className="w-full min-h-screen bg-no-repeat bg-cover bg-center bg-fixed bg-[url('../public/bg.png')]">
          ...
          <div className="w-full min-h-screen bg-no-repeat bg-cover bg-center bg-fixed bg-slate-900 bg-opacity-90 pt-4">
            <h1 className="mt-0 mb-2 text-5xl font-medium leading-tight text-primary text-center text-white">
              The One Million NFT Page
            </h1>
            {treeAccount && <WalletMultiButton />}
              ...
              <>
                <ul className="list-disc">
                  ...
                  <li className="text-sky-400/100">
                    {" "}
                    sequenceNumber: (
                    {treeAccount.tree.sequenceNumber.toString()}){" "}
                  </li>
                </ul>
              </>
            )}
